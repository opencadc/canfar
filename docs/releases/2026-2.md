...
!!! success "CSP 2026.2"
    ...
    **What stays the same?**
    ...
    ### ⚙️ Technical Changes
    - All UI/UX components are now based on a modern technology stack: Next.js, TypeScript, and React.  This will simplify and expedite our capability to iterate and improve the portal components in the future.
