...
<span id="creating-a-notebook-session"></span>
<span id="step-1-access-session-creation"></span>
<span id="step-2-choose-your-container"></span>
<span id="available-containers"></span>
<span id="step-3-configure-session-resources"></span>
<span id="session-name"></span>
<span id="memory-allocation"></span>
<span id="cpu-cores"></span>
<span id="step-4-launch-session"></span>
<span id="using-jupyter-lab"></span>
<span id="interface-overview"></span>
<span id="starting-your-first-notebook"></span>
<span id="persistent-storage-locations"></span>
<span id="working-with-casa"></span>
<span id="advanced-features"></span>
<span id="terminal-access"></span>
<span id="jupyter-extensions"></span>
<span id="collaboration"></span>
<span id="best-practices-for-collaboration"></span>
<span id="sharing-notebooks"></span>
<span id="performance-optimisation"></span>
<span id="memory-management"></span>
<span id="storage-performance"></span>
...
<span id="efficient-data-loading"></span>
...
<span id="accessing-cvmfs-software"></span>
<span id="python-package-management"></span>
<span id="installing-additional-packages"></span>
...
<span id="kernel-not-starting"></span>
<span id="out-of-memory-errors"></span>
<span id="slow-performance"></span>
<span id="file-upload-issues"></span>
