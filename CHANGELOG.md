...
## [1.5.0](https://github.com/opencadc/canfar/compare/v1.4.1...v1.5.0) (2026-09-25)


### Features

* add Science Platform agent skills ([4b5341d](https://github.com/opencadc/canfar/commit/4b5341d62fff8dee9ccb8f57a769ef78091dc847))
* **auth:** expose native OIDC device login APIs ([11a04be](https://github.com/opencadc/canfar/commit/11a04bec3ca1a4578a8a5855442cc2170544fcb4))
* **auth:** expose native OIDC device login APIs ([d6f6ce9](https://github.com/opencadc/canfar/commit/d6f6ce942753dd30dfeb24d37616cd551e4c2e78))
...
* **cli:** replace machine flags with output option ([d892270](https://github.com/opencadc/canfar/commit/d8922703ba53b8e2d824cb2d213c8d0dbcadc872))
* **cli:** replace machine flags with output option ([d379038](https://github.com/opencadc/canfar/commit/d37903875e2c0161c702de0ff6d69d6c1a0d3f22))
* **config:** add bound configuration editor ([7e7aac4](https://github.com/opencadc/canfar/commit/7e7aac4995fc88dea6b4819734feaf858eee296f))
...
* **config:** establish bound Configuration editor ([06a5045](https://github.com/opencadc/canfar/commit/06a50458d2ba6d086978112e61a30cd0a9fd1d93))
...
* **docs:** publish llms.txt and Markdown sources for coding agents ([59a7525](https://github.com/opencadc/canfar/commit/59a752560cb6934d6bd77369a1102d6cd26ea7cb))
* **docs:** redesign landing page and embed acknowledgement ([8c5acda](https://github.com/opencadc/canfar/commit/8c5acda4e6e126d7ce1a7980faa79a1750f83e45))
...
* **presentation:** added presentation for canfar data cli ([d91582b](https://github.com/opencadc/canfar/commit/d91582b87ec155c63dadf8e8f999deff5d45314e))
* **skills:** add CANFAR science workflow guidance ([a3f3a81](https://github.com/opencadc/canfar/commit/a3f3a81671bd0bee5250d295f49c45f7b13461cb))
* **skills:** consolidate platform skills into one tested canfar skill ([970f0e8](https://github.com/opencadc/canfar/commit/970f0e8beed757192dc66c376d4633bca8f54b22))
* **skills:** publish one tested canfar skill, synced with the CLI and docs ([3e79eb3](https://github.com/opencadc/canfar/commit/3e79eb3d50c661e0e2321cfa1e6ffcc56743e017))
...
* address wave 3 review findings ([88fa9d8](https://github.com/opencadc/canfar/commit/88fa9d8631932f6298c7546ec80cb39a03d7474d))
* **agents:** updated core description ([2ef3a00](https://github.com/opencadc/canfar/commit/2ef3a00cb81a1a93566d3d1fd424bac59cd39610))
...
* **auth:** handle OIDC credential expiry and reauthentication ([ff47016](https://github.com/opencadc/canfar/commit/ff47016f7514477903dd21c592dcdbf06f6671d4))
...
* **ci:** address Wave 0 review findings ([31bcb06](https://github.com/opencadc/canfar/commit/31bcb06726d4a0d69571c49527547b3dd4c92126))
* **ci:** fail closed on missing test credentials ([cf1b3fb](https://github.com/opencadc/canfar/commit/cf1b3fb4bd5dea372ac50880afda80d2f4836730))
...
* **ci:** secure merged full test workflow ([687545f](https://github.com/opencadc/canfar/commit/687545f98f63e92c090b021dd24f6a69386cc43e))
...
* **cli:** document ps default status filter ([7117a75](https://github.com/opencadc/canfar/commit/7117a751f63a571e5357538f66225d861a0bdb4a))
...
* **client:** ignore empty runtime tokens ([04bca24](https://github.com/opencadc/canfar/commit/04bca24d93101dc98d1bc872593f60f685959a8a))
* **client:** updated httpx connection pool settings ([59681a7](https://github.com/opencadc/canfar/commit/59681a7d95d671d66f93e554cbfb0e00cd9f7124))
* **cli:** exit nonzero and ask for login when not authenticated ([ede9b06](https://github.com/opencadc/canfar/commit/ede9b0659a627233f601f2a77316ef47f43f44d7))
* **cli:** infer setup output from leaf options ([8c3b6fd](https://github.com/opencadc/canfar/commit/8c3b6fdc2aca6d78632018a619df1b1d810dbc91))
...
* **cli:** satisfy output helper lint ([7238833](https://github.com/opencadc/canfar/commit/7238833b70246ffc6690f9b3ee0d05c79ebe152f))
* **config:** apply domain state transitions atomically ([f06e1c8](https://github.com/opencadc/canfar/commit/f06e1c8959f4ab15a084a0fb6c3ad1cc04a47dc9))
...
* **config:** preserve editor mapping validation ([9126c45](https://github.com/opencadc/canfar/commit/9126c45d4f9c38ac1041eeb14508cc696314c632))
* **config:** preserve source-isolated editor validation ([8bb7605](https://github.com/opencadc/canfar/commit/8bb7605dfb6972d36970de4584fbd745aa042423))
* **config:** preserve source-isolated editor validation ([b37fade](https://github.com/opencadc/canfar/commit/b37fade22254e0d6e46ba51eb3a27661191fd9ce))
...
* **docs:** align client guidance with implemented contracts ([ce8efa3](https://github.com/opencadc/canfar/commit/ce8efa3819cd1dc3f6b2ae76c34dd9f837c290a5))
* keep skill install docs and leak scan accurate ([d352f2a](https://github.com/opencadc/canfar/commit/d352f2a829966eb5749f1d18004ce0a7cb5862f4))
* **logging:** make handler setup idempotent ([40804e8](https://github.com/opencadc/canfar/commit/40804e821da14c4c6c3ade8073eec7889db7ce66))
* **logging:** retain configuration status compatibility ([09776c0](https://github.com/opencadc/canfar/commit/09776c0e833f9be87c28005c693695b5265e48cc))
* **quality:** resolve code-quality findings ([f9ef5ce](https://github.com/opencadc/canfar/commit/f9ef5ce9853d0e059af0d3bc9dbdd17c24e347ff))
* **quality:** resolve PR 276 analyzer findings ([ee63dd8](https://github.com/opencadc/canfar/commit/ee63dd8e15a809bff7de2a2760e2c5ee3559b23d))
...
* **server:** preserve enrich annotation contract ([4115da5](https://github.com/opencadc/canfar/commit/4115da5485a2de8817be9761a234f2178a34053b))
...
* stop vos:/arc from targeting Vault ([523939e](https://github.com/opencadc/canfar/commit/523939eb81eeb8a265e8f7beb8e605b8d556233e))
...
* **test:** isolate pytest home per run ([169a330](https://github.com/opencadc/canfar/commit/169a330046f88b3df348992cd55aa2f0bc653790))
* **test:** isolate pytest HOME per run ([4b7f610](https://github.com/opencadc/canfar/commit/4b7f61086f4db9301de08116f1223f0382640a0f))
...
* **agent:** updated docs ([90e9971](https://github.com/opencadc/canfar/commit/90e997158a94d99696d3437ffdb57ab2ba3969c0))
...
* **alma:** replace screenshot guides with text workflow ([4c9d3b2](https://github.com/opencadc/canfar/commit/4c9d3b216dd9a20f14f617413ea5aca1093f0d03))
* **alma:** replace screenshot guides with text workflow ([31ca84d](https://github.com/opencadc/canfar/commit/31ca84da21ebef412ec031b1a7c1a6946de0c60b))
* **alma:** use glossary terminology ([8384e92](https://github.com/opencadc/canfar/commit/8384e9268345c6140858ed5788e3bee18dac9475))
* **auth:** document Python OIDC login ([4c157c7](https://github.com/opencadc/canfar/commit/4c157c765a2908ec60a5bedb567e2e32699209ad))
* **auth:** link Python login guidance ([8813704](https://github.com/opencadc/canfar/commit/8813704d39282df6cc2a1055693f87648fd075b5))
* clarify replica resource allocation ([1930116](https://github.com/opencadc/canfar/commit/193011629627e374f1e57ab5cc5646efbd87c9ee))
* **cli:** align command reference with shipped interface ([3171cb2](https://github.com/opencadc/canfar/commit/3171cb2da0af3fe77089d9c44179ab2a0472a85a))
* **cli:** align command reference with shipped interface ([85b5ac6](https://github.com/opencadc/canfar/commit/85b5ac69936bf1734f93d681c66ea4952e1edcf7))
...
* **cli:** document output format option ([a44ab5e](https://github.com/opencadc/canfar/commit/a44ab5e6cdb9021da17378a2b3c7fc99b2af481c))
...
* **client:** audit Python API documentation ([f8d7d28](https://github.com/opencadc/canfar/commit/f8d7d28bb10cb9b55743595e19a1059214a757fd))
* **client:** audit Python API documentation ([495a5b8](https://github.com/opencadc/canfar/commit/495a5b89d3d93da2f2b4dac4b27f72f5771bede6))
* **client:** close filesystem examples ([7df7a18](https://github.com/opencadc/canfar/commit/7df7a186dfbc795b515ad0ab08d226513d90f0b5))
* **client:** drop the removed auth login alias ([2ad7dc3](https://github.com/opencadc/canfar/commit/2ad7dc32d4b7aadf4e1bfc69ef10d446d22da9bf))
...
* **cli:** remove stale command aliases ([19d22b8](https://github.com/opencadc/canfar/commit/19d22b886871134578e748b81b93212c11200b16))
* close remote after cache setup failures ([72cf887](https://github.com/opencadc/canfar/commit/72cf887530ca86e73da598d01101aa07e1be8f63))
* **contributing:** document CI test policy ([e0ad198](https://github.com/opencadc/canfar/commit/e0ad198c4120451c5855ce38bf0b55749248e309))
* correct machine output and storage API contracts ([12e5037](https://github.com/opencadc/canfar/commit/12e50377b335d51ab6fbbe8df168957ab98feead))
...
* guide users from first sessions to recoverable pipelines ([d8936e0](https://github.com/opencadc/canfar/commit/d8936e02f3cfce6f727f106e9c37b239525a99e3))
...
* make client data guide canonical ([8312d28](https://github.com/opencadc/canfar/commit/8312d2883aebfb30f27dfd2adbef62dfc05a1c37))
* **platform:** align IDP and server terms ([f175c98](https://github.com/opencadc/canfar/commit/f175c981b823ad87199fcbbccf0c93534e7bfbc9))
* **platform:** describe limits as each provider's, with CANFAR's values ([96d23d7](https://github.com/opencadc/canfar/commit/96d23d7e069b5b2839a85d2391d602c67b2b100c))
* **platform:** document Session limits and concurrent storage use ([a498b7a](https://github.com/opencadc/canfar/commit/a498b7a5aae7cdf03ce04de66e891b345c5d7070))
* **platform:** record operator facts confirmed by a maintainer ([3776432](https://github.com/opencadc/canfar/commit/377643216b0743985d8b417d46d5308d3b74458a))
* **platform:** upstream verified platform knowledge from the skills ([af0ed56](https://github.com/opencadc/canfar/commit/af0ed564352856b05c498ac60fd9e17dc18c1ac2))
* **platform:** use deployment-neutral server examples ([e749871](https://github.com/opencadc/canfar/commit/e749871ae49977dfd0ba4fb05ae9d1eb70f66715))
...
* restore familiar navigation and legacy bookmarks ([de35c4c](https://github.com/opencadc/canfar/commit/de35c4cf92c5e71484c8f10cb8483e4849a524f3))
* restore science workflows and document client upgrades ([6ccf7c4](https://github.com/opencadc/canfar/commit/6ccf7c4738109c65e619b95d355501e37db54758))
* **site:** align platform workflows and support guidance ([4cb6e1b](https://github.com/opencadc/canfar/commit/4cb6e1ba64aa3897cb72e86a5df42e544cfa4e71))
* **site:** remove unreferenced legacy assets ([4fa4c68](https://github.com/opencadc/canfar/commit/4fa4c6806e825c70da75e993a5e7ecffa9b676f8))
* **skills:** updated docs for agentic skills ([0a9ba1e](https://github.com/opencadc/canfar/commit/0a9ba1ead84960be7b62572a8ac78b9618e0eaab))
* **skills:** updated docs for agentic skills ([c9222b6](https://github.com/opencadc/canfar/commit/c9222b6e3f03d087c27b4cc28afbe6d3cc528f9d))
* **storage:** clarify explicit filesystem and staging workflows ([8bb5991](https://github.com/opencadc/canfar/commit/8bb5991ec45c4a7dc80c4d9f03fb2994d5b10a6c))
* **storage:** correct filesystem lifecycle examples ([3a19541](https://github.com/opencadc/canfar/commit/3a1954128644492bbc2028c1ffb6e1d255737b4c))
* **storage:** document explicit filesystem access ([4b54f7a](https://github.com/opencadc/canfar/commit/4b54f7a34bf176bfc61e38e78e6f6a13ced904fe))
...
* use Session terminology in user guides ([99dd809](https://github.com/opencadc/canfar/commit/99dd80932f06190c4c1d9770ea721da3b359ac58))
...
* put latest release on top in side nave ([1a3abd2](https://github.com/opencadc/canfar/commit/1a3abd234e11b74a4268533ed8b07b28de8bf4a3))
